...
char myGrade = 'A';
printf("%c", myGrade);
//using ASCII values to represent characters, we can assign integer values to char variables. For example, the ASCII value of 'A' is 65, 'B' is 66, and 'C' is 67. We can use these values to print t[...]
char a = 65, b = 66, c = 67;
printf("%c", a);
printf("%c", b);
printf("%c", c);
